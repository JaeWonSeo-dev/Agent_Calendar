...
export default function ChatPanel({ chatLines, chatInput, onChatInputChange, onSend }: Props) {
  return (
    ...
    >
      ...
      <div style={{ flex: 1, border: '1px solid #e5e7eb', borderRadius: 20, padding: 14, marginTop: 16, overflowY: 'auto', background: '#fff' }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginTop: 16 }}>
        <input value={chatInput} onChange={(e) => onChatInputChange(e.target.value)} type="text" placeholder="공유 캘린더에 대해 물어보기" style={{ flex: 1, padding: 12, borderRadius: 14, border: '1px solid #dbe2ea' }} />
